      ...
      <div className="h-full bg-[#0A092D] w-[250px] shadow-xl flex flex-col gap-5 p-2 border-l border-white/20">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="gap-4 flex sm:hidden flex-col">
            <Link href="/home" onClick={() => setSidebarOpen(false)} className="relative w-full group pl-4">
              <div
                className={`${
            ...
            <button
              className="relative flex group pl-4"
            ...
            {isLibraryOpen && (
              <LibraryDropdown setIsLibraryOpen={setIsLibraryOpen} setSidebarOpen={setSidebarOpen} />
            )}
          </div>
            ...
            {!isLoading &&
              (currentUser ? (
                <>
                  <Link
                    href="/create-set"
                    className="z-20 bg-blue-600 hover:bg-indigo-600 hover:scale-105 transition-all rounded-full pl-2 pr-3 py-1 cursor-pointer w-fit flex gap-1 items-center"
